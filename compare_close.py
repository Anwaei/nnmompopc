...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_folder_n_b', type=str, default="pics/results_open_20250210-0038_14", help='Folder for non-morphing both data')
    parser.add_argument('--file_folder_m_b', type=str, default="pics/results_open_20250210-0038_14", help='Folder for morphing both data')
    ...
    # Plot
    pu.plot_comparison_close(pic_folder=pic_folder, result_nomorphing=results_n, result_nomorphing_both=results_n_b, result_morphing_both=results_m_b, result_net=results_net, trajectory_ref=tra_ref)
