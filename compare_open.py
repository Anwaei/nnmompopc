...
if __name__ == '__main__':
     ...
     parser.add_argument('--file_folder_n_m', type=str, default="pics/results_open_20250128-1659", help='Folder for non-morphing fuel data')
     parser.add_argument('--from_file_m_m', action='store_true', help='Load morphing fuel data from file')
     parser.add_argument('--file_folder_m_m', type=str, default="pics/results_open_20250131-1701", help='Folder for morphing fuel data')
     parser.add_argument('--from_file_n_b', action='store_true', help='Load non-morphing fuel data from file')
     parser.add_argument('--file_folder_n_b', type=str, default="pics/results_open_20250128-1659", help='Folder for non-morphing fuel data')
     parser.add_argument('--from_file_m_b', action='store_true', help='Load morphing fuel data from file')
     parser.add_argument('--file_folder_m_b', type=str, default="pics/results_open_20250131-1701", help='Folder for morphing fuel data')
