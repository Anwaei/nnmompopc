...
if __name__ == '__main__':
     from_file_n = False
     file_folder_n = "results_open_20250124-1259"
     from_file_m = False
     file_folder_m = "results_open_20250124-1259"
     from_file_n_f = False
     file_folder_n_f = "results_open_20250124-1259"
     from_file_m_f = False
     file_folder_m_f = "results_open_20250124-1259"
     ...
     if from_file_n:
          ...
          x_optimal, y_optimal, z_optimal, u_optimal, j_optimal = opt.generate_PS_solution_scaled(x0=config_opc.PARA_X0, trajectory_ref=tra_ref, morphing_disabled=0.5)
     ...
     if from_file_n_f:
          ...
          x_optimal, y_optimal, z_optimal, u_optimal, j_optimal = opt.generate_PS_solution_scaled(x0=config_opc.PARA_X0, trajectory_ref=tra_ref, morphing_disabled=0.5, fun_obj=opt.function_objective_fuel)
